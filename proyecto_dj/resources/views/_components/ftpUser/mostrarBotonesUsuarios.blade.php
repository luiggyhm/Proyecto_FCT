        ...
        <div class="col-12 mb-4">
            <nav>
                <ul class="list-unstyled text-center m-0 p-0">
                    ...
                    <li class="bg-dark text-white mb-2 p-3 rounded">
                        <a class="text-decoration-none text-white" href="#">Modificar Usuario</a>
                    </li>
                    <li class="bg-dark text-white mb-2 p-3 rounded">
                        <a class="text-decoration-none text-white" href="#">Activar Usuario</a>
                    </li>
                    <li class="bg-dark text-white mb-2 p-3 rounded">
                        <a class="text-decoration-none text-white" href="#">Desactivar Usuario</a>
                    </li>
